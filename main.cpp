...
void display()
{
    ...
    if (value == -1)
    {
        char cn[] = "RV University";
        drawhead(-620, 900, 0, cn);
        char pn[] = "Mysore Road, Banglore - 560098";
        drawsubhead(-300, 850, 0, pn);

        char dn[] = "SCHOOL OF COMPUTER SCIENCE & ENGINEERING";
        ...
        char p1u[] = "1RVU22CSE069";
        drawsubhead(-690, -300, 0, p1u);

        char p2[] = "Pranav P Kulkarni";
        drawhead(-690, -400, 0, p2);
        char p2u[] = "1RVU22CSE119";
        drawsubhead(-690, -450, 0, p2u);

        char gb[] = "GUIDED BY: ";
        drawhead(290, -150, 0, gb);

        char g1[] = "Evlin Vidyu Latha P";
        drawhead(290, -250, 0, g1);
        char d1[] = "Assistant Professor, SOCSE, RV University";
